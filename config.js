...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '🧚ᴘɪɴᴋ<ᴠᴇɴᴏᴍ🧚',
    ...
    BOT_INFO: process.env.BOT_INFO || '🧚ᴘɪɴᴋ<ᴠᴇɴᴏᴍ🧚;🦄Aʏᴏᴅʏᴀ🦄;94772496127;https://telegra.ph/file/4f6930ac781d99e24c4b2.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '🧚ᴘɪɴᴋ_ᴠᴇɴᴏᴍ_ᴍᴅ🧚;🎀ᴀʸᵒᵈʸᴀ〠🎀;https://telegra.ph/file/2dae9decf20130a12a72e.mp4' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'p𝛪nk v𝛯no𝛭;𝛥yodya' : process.env.STICKER_DATA,
